...
if ( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
    ...
    <img src="./assets/icons/${key.dataset.key}.png" alt="">
    <p class="sound"> ${key.lastElementChild.innerText} </p>`)
    keys.forEach((key) =>
    ...
    instructions.innerText = 'Press A, S, D, F, G, H, J, K to hear an animal sound.'
